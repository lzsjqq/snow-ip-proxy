package com.snow.ip.proxy.util;


import com.snow.ip.proxy.download.PhantomJSDownloaderSetting;
import com.snow.ip.proxy.proxy.IpObject;
...
public class SeleniumUtil {
    ...
    public static WebDriver getPhantomJSDriver(PhantomJSDownloaderSetting setting, Map<String, String> properties) {
        ...
        try {
            ...
            cc.setCapability("phantomjs.page.settings.userAgent", USER_AGENT);
            if (properties != null) {
